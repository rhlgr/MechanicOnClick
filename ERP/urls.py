...
from .views import add_vehical , edit_vehical , info_vehical , add_service , customer_services , approve_service , service_updates
urlpatterns = [
    ...
    path('services/update/<str:pk>', service_updates , name ='customer_service_updates_page'),
